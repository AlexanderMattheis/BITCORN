...
public class ContactRecord extends UpdatableRecordImpl<ContactRecord> implements Record4<Integer, Timestamp, String, String> {

    private static final long serialVersionUID = -742927625;

    /**
     * Setter for <code>bitcorn.contact.id</code>.
     */
    ...
    /**
     * Getter for <code>bitcorn.contact.id</code>.
     */
     ...
     */
    @Override
    public ContactRecord value2(Timestamp value) {
        setReceived(value);
        return this;
    }
     ...
     */
    @Override
    public ContactRecord values(Integer value1, Timestamp value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ContactRecord(Integer id, Timestamp received, String email, String message) {
        super(Contact.CONTACT);
