...
;define("bitcorn/components/bs-navbar", ["exports", "ember-bootstrap/components/bs-navbar"], function (_exports, _bsNavbar) {
  ...
  class BsNavbar extends _bsNavbar.default.extend({
    didInsertElement() {
...
;
          if (!runningTests) {
            require("bitcorn/app")["default"].create({"name":"bitcorn","version":"0.0.0+1c47601b"});
          }
